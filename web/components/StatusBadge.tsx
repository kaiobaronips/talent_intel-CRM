...
const toneByValue: Record<string, string> = {
  ...
  expandi_delegated: 'border-sky-300 bg-sky-50 text-sky-800',
  expandi_queued: 'border-sky-300 bg-sky-50 text-sky-800',
  expandi_synced: 'border-sky-300 bg-sky-50 text-sky-800',
  expandi_invitation_sent: 'border-blue-300 bg-blue-50 text-blue-800',
  expandi_connected: 'border-emerald-300 bg-emerald-50 text-emerald-800',
  expandi_replied: 'border-emerald-300 bg-emerald-50 text-emerald-800',
  expandi_failed: 'border-rose-300 bg-rose-50 text-rose-800',
  expandi_paused: 'border-amber-300 bg-amber-50 text-amber-900',
...
const labelByValue: Record<string, string> = {
  ...
  expandi_queued: 'Na fila do LinkedIn',
  expandi_synced: 'Status sincronizado',
  expandi_invitation_sent: 'Convite enviado',
  expandi_connected: 'Conectado',
  expandi_replied: 'Resposta recebida',
  expandi_failed: 'Falhou no Expandi',
  expandi_paused: 'Pausado por limite',
