  ...
  items: [
    {
      ...
      seniority: 'Senior',
      classification: 'A',
      classification_reason: 'Aderência alta por experiência no mercado financeiro e canais de contato disponíveis.',
      profile_summary: 'Assessor de investimentos com perfil comercial e atuação consultiva.',
      recommended_action: 'Priorizar abordagem consultiva pelo LinkedIn e reforçar oportunidade de crescimento.',
      score_overall: 86,
      stage: 'contacted',
    },
    {
      ...
      seniority: 'Pleno',
      classification: 'B',
      classification_reason: 'Boa aderência, mas depende de validação do momento profissional.',
      profile_summary: 'Consultora financeira com experiência comercial e potencial para carteira qualificada.',
      recommended_action: 'Iniciar contato por LinkedIn e confirmar abertura para conversa.',
      score_overall: 74,
      stage: 'enriched',
    },
  ],
